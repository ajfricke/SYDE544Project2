...
class Net(nn.Module):
    def __init__(self, number_of_class, batch_size=300, number_of_channel=8, learning_rate=0.02, dropout=.5):
        ...
        for i in range(4):
            ...
            self._first_part_dropout1.append(McDropout.McDropout())
            self._first_part_dropout2.append(McDropout.McDropout())
        ...
        for i in range(2):
            ...
            self._second_part_dropout1.append(McDropout.McDropout())
        ...
        self._dropout3 = McDropout.McDropout()
        ...
        self._dropout_fc1 = McDropout.McDropout()
        ...
        self._dropout_fc2 = McDropout.McDropout()
