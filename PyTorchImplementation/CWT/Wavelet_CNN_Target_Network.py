...
class SourceNetwork(nn.Module):
    def __init__(self, number_of_class, dropout_rate=.5):
        ...
        for i in range(4):
            ...
            self._first_part_dropout1.append(McDropout.McDropout(p=dropout_rate))
            self._first_part_dropout2.append(McDropout.McDropout(p=dropout_rate))
        ...
        for i in range(2):
            ...
            self._second_part_dropout1.append(McDropout.McDropout(p=dropout_rate))
        ...
        self._dropout_fc1 = McDropout.McDropout(p=dropout_rate)
        ...
        self._dropout_fc2 = McDropout.McDropout(p=dropout_rate)
...
class TargetNetwork(nn.Module):
    def __init__(self, number_of_class, weights_pre_trained_cnn, dropout=.5):
        ...
        for i in range(4):
            ...
            self._first_part_target_dropout1.append(McDropout.McDropout())
            self._first_part_target_dropout2.append(McDropout.McDropout())
        ...
        for i in range(2):
            ...
            self._second_part_target_dropout1.append(McDropout.McDropout())
        ...
        self._target_dropout_fc1 = McDropout.McDropout()
        ...
        self._target_dropout_fc2 = McDropout.McDropout()
